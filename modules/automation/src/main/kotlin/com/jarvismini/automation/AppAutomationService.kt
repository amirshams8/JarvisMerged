...
import android.accessibilityservice.AccessibilityService import android.accessibilityservice.AccessibilityServiceInfo import android.view.accessibility.AccessibilityEvent import android.view.accessibility.AccessibilityNodeInfo import android.util.Log import com.jarvismini.automation.decision.ReplyDecision import com.jarvismini.automation.input.AutoReplyInput import com.jarvismini.automation.orchestrator.AutoReplyOrchestrator
class AppAutomationService : AccessibilityService() {
private val TAG = "JarvisMini-AutoService"
private var serviceInfoInitialized = false

override fun onServiceConnected() {
    super.onServiceConnected()
    Log.i(TAG, "Automation Service connected")
    if (!serviceInfoInitialized) {
